    ...
    'scripts/app.js':
      ...
      order:
        before: [
          ...
          'vendor/scripts/jquery.mobile.router.js'
          'vendor/scripts/jquery.mobile-1.0.1.min.js'
        ]
    ...
    'styles/app.css':
      ...
      order:
        before: [
            ...
            'vendor/styles/jquery.mobile-1.0.1.min.css'
        ]
        after: ['vendor/styles/jquery.overrides.css']
